    ...
    public class Core
    {
        ...
        public static void RemoveCrawler(string roomKey)
        {
            ...
            try
            {
                ...
                if (!taskFinished)
                {
                    Console.WriteLine("ERROR: The task could not be ended within 5 seconds.");
                }
            }
        ...
        public static void CreateCrawler(string roomKey, AutoResetEvent createCrawlerHandle)
        {
            ...
            var crawlerTask = Task.Factory.StartNew(state =>
            {
                ...
                Console.WriteLine("Created a crawler: " + roomKey);
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Finished listing lobby.");

            Console.WriteLine("Auto adjusting worker pool...");
            ...
            Repeat.Interval(
                TimeSpan.FromMinutes(8), Pool.AutoAdjust, cancellationTokenSource.Token);
           ...
           /* while (!Console.ReadLine().StartsWith("q"))
            ...
            if (info.Key == ConsoleKey.Q)
            {
                ...
                {
                    Console.WriteLine("Gracefully ending crawler...");
                    ...
                    {
                        Console.WriteLine("Soft error: " + e.Message);
                    }
                }
            }
